...
namespace TDM.Application.Doc.VesselLoadingPermits.DTOs
{
    public class VesselLoadingPermitDto
    {
        ...
        public object BulkList { get; set; }
        public object GeneralCargoList { get; set; }
        public object ContainerList { get; set; }
    }
}
