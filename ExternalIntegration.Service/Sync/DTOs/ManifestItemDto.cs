namespace ExternalIntegration.Service.Sync.DTOs
{
    public class ManifestItemDto
    {
        ...
        public ManifestCompanyDto ShippingOrForwarderCompany { get; set; }
        public List<ManifestContainerDto> ContainersList { get; set; }
        public List<ManifestGeneralCargoDto> GeneralCargoList { get; set; }
        public List<ManifestBulkDto> BulkList { get; set; }
