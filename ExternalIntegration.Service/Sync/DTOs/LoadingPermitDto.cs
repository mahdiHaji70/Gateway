namespace ExternalIntegration.Service.Sync.DTOs
{
    public class LoadingPermitDto
    {
        ...
        public List<LoadingPermitBulkDto> BulkList { get; set; } 
        public List<LoadingPermitGeneralCargoDto> GeneralCargoList { get; set; } 
        public List<LoadingPermitContainerDto> ContainerList { get; set; } 
    }
}
