namespace ExternalIntegration.Service.Sync.DTOs
{
    public class VesselLoadingPermitDto
    {
        ...
        public List<VesselLoadingPermitBulkDto> BulkList { get; set; }
        public List<VesselLoadingPermitGeneralCargoDto> GeneralCargoList { get; set; }
        public List<VesselLoadingPermitContainerDto> ContainerList { get; set; }
    }
}
