...
{
    public class VesselLoadingPermitResultDto
    {
        ...
        public string CargoUnitizeTypeName { get; set; }
        ...
        public List<VesselLoadingPermitBulkDto> BulkList { get; set; } = new();
        public List<VesselLoadingPermitGeneralCargoDto> GeneralCargoList { get; set; } = new();
        public List<VesselLoadingPermitContainerDto> ContainerList { get; set; } = new();
    }
}
