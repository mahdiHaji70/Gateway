...
{
    public class VesselLoadingPermitResponseDto
    {
        ...
        public List<VesselLoadingPermitBulkResponseDto> BulkList { get; set; }
        public List<VesselLoadingPermitGeneralCargoResponseDto> GeneralCargoList { get; set; }
        public List<VesselLoadingPermitContainerResponseDto> ContainerList { get; set; }
    }
}
