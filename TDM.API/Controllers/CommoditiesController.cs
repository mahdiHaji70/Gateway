...
namespace TDM.API.Controllers
{
    ...
    public class CommoditiesController : Controller
    {
        ...
        {
            var result = await _mediator.Send(new GetCommodityByIdQuery(id));
        ...
        {
            var result = await _mediator.Send(new GetCommoditiesQuery(pageNumber, pageSize));

            return Ok(ApiResponse.Success(result));
        }

        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateCommodityCommand command, CancellationToken cancellationToken)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] UpdateCommodityCommand command, CancellationToken cancellationToken)
        {
            var id = await _mediator.Send(command, cancellationToken);
        ...
        {
            await _mediator.Send(new DeleteCommodityCommand(id), cancellationToken);
